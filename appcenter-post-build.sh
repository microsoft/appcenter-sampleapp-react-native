...
TEST_RUN=$(appcenter-cli test run xcuitest --app "Build2018/ac-github-ios" --devices "Build2018/release-devices" --test-series master --locale en_US --build-dir DerivedData/Build/Products/Release-iphoneos --token  --async | pcregrep -o1 -M 'Test run id: "(.+)"');
