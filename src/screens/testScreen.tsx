        ...
        <BaseScreen
          options={{
            ...
            bottomContainer: {
              ...
              description:
                "Run your tests on more than 400 unique device configurations. Tests can be written for iOS and Android apps with Xamarin.UITest, Appium, Espresso (Android), and XCUITest (iOS).\n\nBacked by Xamarin Test Cloud."
            }
          }}
        />
      </View>
