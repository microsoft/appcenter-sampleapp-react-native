...
const RootStack = createMaterialTopTabNavigator({Welcome: WelcomeScreen, Build: BuildStack, Test: TestStack,
CodePush: CodePushStack, Distribute: DistributeStack, Crashes: CrashesStack, Analytics: AnalyticsStack,
Push: PushStack},
{
